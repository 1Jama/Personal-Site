...
export const ProjectData = [
  {
    ...
    description:
      'Dynamic React app to practise basic levels of the Spanish language. Contains two levels of difficulty tallying score on right answers. Robust backend made using MongoDB and Node.Js, as well as utilizing multiple Restful APIs for things like determining correctness in hard mode.',
